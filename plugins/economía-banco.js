// ═════════════════════════════════════════════════════════════════
// COMANDO: .banco (Depositar y Retirar Saldo )
...
_...bóveda encriptada._ 🕷️
    ...
    if (accion === 'retirar' || accion === 'ret') {
        ...
        if (!cantidad || cantidad < 50) {
            return m.reply(`❌ El retiro mínimo de las bóvedas es de $50 ${global.moneda}.\n📌 Uso: .banco ret <cantidad/all>`)
        }
...
🏦 Bóveda: $${user.eco.banco} ${global.moneda}
