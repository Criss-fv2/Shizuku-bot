...
// RUTA: plugins/economia-bounty.js
// ═════════════════════════════════════════════════════════════════
...
💵 Secreto de Pago: +$${cantidad} ${global.moneda}

*El cartel pagó $${cantidad} ${global.moneda} por tu cabeza.*
📢 NOTA: Usa el comando *.cazar @user* para recibir la recompensa.
...
*Te deshiciste de la amenaza y el cartel te pagó $${botinCobrado} ${global.moneda}.*

📌 Cartera Cazador: $${cazador.eco.dinero} ${global.moneda} | Rango: Nivel ${cazador.eco.level}
