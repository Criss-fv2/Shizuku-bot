let handler = async (m, { conn }) => {
    ...
    const infoText = `🕸 *INFO DEL BOT - ${botname}* 🕸\n\n` +
                     ...
                     `▪️ *Creado por:* 𝑪𝒓𝒊𝒔𝒔-𝒇𝒗\n` +
                     `▪️ *Repo GitHub:* https://github.com/Criss-fv/Shizuku-bot\n` +
                     `▪️ *Canal oficial:* https://whatsapp.com/channel/0029VbD0BCmHLHQZCYJ7d42K\n\n` +
                     `¡Soy ${botname} y estoy lista para ayudarte\~! 🖤\n` +
